<%!
    ...
    git_link_template = 'https://github.com/lluissalord/radiology_ai/blob/{commit}/{path}#L{start_line}-L{end_line}'
    ...
    google_search_query = 'inurl:github.com/lluissalord/radiology_ai  site:radiology_ai.github.io  site:radiology_ai.website'
