...
class SCELoss(FastaiLoss):
    ...
    def forward(self, pred, labels):
        ...
        label_one_hot = torch.nn.functional.one_hot(labels.long(), self.num_classes).float().to(self.device)
...
class FocalLossFlat(BaseLoss):
    ...
    y_int = True
    def __init__(self, weight=None, ignore_index=-100, reduction='mean', *args, axis=-1, **kwargs): 
        super().__init__(FocalLoss, weight=weight, ignore_index=ignore_index, reduction=reduction, *args, axis=axis, **kwargs)
        self.axis = axis
